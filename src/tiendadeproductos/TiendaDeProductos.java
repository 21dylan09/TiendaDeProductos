...
public class TiendaDeProductos {
    ...
    System.out.println("ººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººººº" );
        System.out.println("Elaboración de expresiones condicionales:");
        System.out.println("Método subirValorUnitario");
        System.out.println("El valor a pagar es de: " + P1.subirValorUnitario(55000));
        System.out.println("Método hacerPedido?");
        System.out.println("Hacer pedido?" + P1.hacerPedido(false));
        System.out.println("Método cuantoPedir?");
        System.out.println("");
        System.out.println(" Método cambiarValorUnitario");
        System.out.println("El valor a pagar es de: "+miTienda.getP1().subirValorUnitario(rIva));
        System.out.println("Método cuantosPapeleria");
